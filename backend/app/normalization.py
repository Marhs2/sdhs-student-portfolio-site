...
JOB_ALIASES = {
    ...
    _normalize_key("그래픽"): "그래픽 디자인",
    _normalize_key("그래픽 디자인"): "그래픽 디자인",
    _normalize_key("graphicsdesigner"): "그래픽 디자인",
    _normalize_key("graphicdesigner"): "그래픽 디자인",
    ...
    _normalize_key("데이터 분석"): "데이터 분석",
    _normalize_key("dataanalytics"): "데이터 분석",
    _normalize_key("dataanalyst"): "데이터 분석",
    _normalize_key("mobile"): "모바일",
    _normalize_key("mobileapp"): "모바일",
    _normalize_key("appdeveloper"): "모바일",
